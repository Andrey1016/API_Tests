...
def test_update_item_summary(creating_item):
    ...
    created_item_id = creating_item.create_standard_item()
    update_item.update_item_summary(created_item_id)
    update_item.check_updated_summary()
    delete = CreateItem()
    delete.delete_standard_item(created_item_id)
...
def test_update_item_text_area(creating_item):
    ...
    create_item_id = creating_item.create_standard_item()
    ...
    delete = CreateItem()
    delete.delete_standard_item(create_item_id)
